  ...
  return (
    <>
      ...
      <div className="relative flex items-center justify-center w-full h-96 overflow-hidden font-text mt-10">
        ...
        <div
          className="absolute z-39 border-2 border-[#06B6D4]/30 rounded-3xl h-64 w-64 bottom-20 rotate-[70deg]"
          style={{ borderRadius: '60% 30% 100% 40%' }}
        />

        <div
          className="absolute z-40 bg-linear-to-bl from-[#06B6D4]/20 via-[#3B82F6]/20 to-[#7C3AED]/20 rounded-3xl h-64 w-64 bottom-20 rotate-[-20deg]"
          style={{ borderRadius: '60% 30% 100% 40%' }}
        />

        <div
          className="absolute z-41 border-2 border-[#06B6D4]/30 rounded-3xl h-64 w-64 bottom-20 rotate-[-80deg]"
          style={{ borderRadius: '60% 30% 100% 40%' }}
        />

        <div
          className="absolute z-42 bg-linear-to-br from-[#06B6D4]/40 via-[#3B82F6]/40 to-[#7C3AED]/60 h-64 w-64"
        ...
        <div className="absolute z-44 bottom-10">
          <div className="bg-[#101A2E]/60 px-4 py-2 rounded-xl border-2 border-[#06B6D4]/30 flex items-center gap-2 ">
        ...
        <div className="absolute z-44 right-8 top-13 text-sm">
          <div className="bg-[#101A2E]/60 p-2 rounded-xl border-2 border-[#06B6D4]/30">
