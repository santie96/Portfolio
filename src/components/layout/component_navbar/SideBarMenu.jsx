        ...
        <>
            ...
            <div className={`fixed top-0 left-0 w-full h-dvh bg-gray-900 z-50 transition-all duration-500 ease-in-out ${isOpen ? "translate-x-0 opacity-100" : "-translate-x-full opacity-0 pointer-events-none"}`}>
                <div className="flex flex-col gap-6">
                    <div className="group flex justify-end items-center p-7">
                        <button className="cursor-pointer group-hover:bg-accent rounded-full duration-300"
                            onClick={onClose}
                        >
                            <IoClose className="text-3xl md:text-4xl text-text-inverse font-mono" />
                        </button>
                    </div>



                    <ul className="w-full flex flex-col items-center  text-2xl text-text-inverse">
                        <li className="w-full group">
                            <NavLink className="transition-colors flex items-center justify-center group-hover:bg-accent duration-300 px-5 py-8 font-mono"
                                to="/progetti"
                                onClick={onClose}
                            >
                                Progetti
